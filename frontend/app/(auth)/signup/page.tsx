  ...
  useEffect(() => {
    ...
    if (err) {
      ...
      if (lowerErr.includes("google") || lowerErr.includes("authenticate") || lowerErr.includes("oauth")) {
        ...
        lowerErr.includes("finished") ||
        lowerErr.includes("reached")
      ) {
        setError("Signup temporarily limited. Please try again later.")
      } else {
        setError(err)
      }
    }
    ...
    return (
      <div className="text-center">
        ...
        <button
          ...
          disabled={resending}
          className="text-xs text-muted-foreground hover:text-foreground mb-4 block w-full text-center hover:underline disabled:opacity-50"
        >
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        >
          {emailLoading ? <><Loader2 className="w-4 h-4 animate-spin" /> Creating...</> : "Create account"}
        </button>
      </form>
  ...
  return (
    <Suspense fallback={
      <div className="flex flex-col items-center justify-center p-6 gap-3">
        ...
        <div className="text-xs text-muted-foreground">Loading signup form...</div>
      </div>
    }>
      <SignupForm />
    </Suspense>

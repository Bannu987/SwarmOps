...
ppc_strategy_template = AGENT_CONVERSATIONAL_RULES + """You are a senior PPC strategist. Analyze the campaign request and research below, then provide specific, actionable paid advertising recommendations.
